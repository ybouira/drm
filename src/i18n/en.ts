export const en = {
  common: {
    ...
    startAProjectArrow: "Start a project →",
    startup: "STARTUP",
  ...
  hero: {
    ...
    mid: "ambition into",
    startups: "startups",
    body: "The Founder Program is where you stop dreaming about starting a company and actually do it. Real work. Real mentorship. A team that co-builds with you.",
    howWeWork: "How we work",
    programPhases: "Program Phases",
  },
  build: {
    thisIs: "This is",
    title: "Where you build your first startup.",
    body: "A highly selective program where young entrepreneurs validate business ideas, build their startup and grow alongside a network of other entrepreneurs, mentors and investors.",
    cards: [
      {
      ...
      },
      {
        ...
        description:
          "When the model works, Drommer helps you turn it into a company.",
      },
      {
        label: "FOUNDER NETWORK",
        description:
          "Entrepreneurs, operators, investors. You're not alone in the room.",
      },
    ],
  },
  marquee: [
  ...
  pillars: {
    eyebrow: "IN 4 PILLARS",
    title: "What makes this different",
    bodyLine1: "Not a course. Not a bootcamp. A structured path to launch your own startup, with",
    bodyLine2: "people who've done it before.",
    items: [
      {
  ...
  mission: {
    eyebrow: "MISSION",
    titleLine1: "Young founders in.",
    titleLine2: "Startups out.",
    p1: "Drommer is a venture builder studio based in Ticino (CH). We run the Founder Program to find, develop and co-build incredible ventures with the next generation of entrepreneurs in Europe.",
    p2: "We don’t teach entrepreneurship. We practice it. Everyone who enters the program works on real problems, gets real feedback, and builds toward a real company, with a team of other founders.",
    moreAboutUs: "More about us",
  },
  phases: {
    eyebrow: "PROGRAM PHASES",
    title: "How the Founder Program works",
    subtitle: "Four steps to turn a real problem into an AI-native service business.",
    items: [
      {
      ...
      {
        title: "Build Weekend",
        body: "Selected founders join an intensive in-person experience at Drommer HQ in Chiasso to challenge the idea, build the first venture proposal and compete in a final pitch competition.",
      },
      {
        title: "10 Weeks to Revenue",
        bodyBefore: "The strongest founders earn a place into a",
        bodyStrong: "free 10-week journey",
        bodyAfter:
          "focused on validation, offer design, pricing, customer acquisition and first revenue.",
      },
      {
  ...
  overview: {
    ...
    title: "What you get & who it’s for",
    subtitle: "A real program. Real access. Real people behind it.",
    whatYouGet: "What you get",
    whatYouGetIntro1: "Everything you need to go from idea to launch, and nothing you don't.",
    whatYouGetIntro2: "The program is free for selected founders.",
    whoItsFor: "Who it’s for",
    whoItsForIntro: "We look for people who are serious about building, not just thinking about it.",
    exploreChallenge: "Explore the current challenge →",
    whatYouGetItems: [
      {
  ...
  caseStudiesHome: {
    eyebrow: "CASE STUDY",
    title: "Companies we've build with founders",
    ...
    okrogito: "An agent to buy and sell your home, completely private-to-private.",
    prisma: "Turn your content creation into an AI-powered business.",
  },
  builtWith: {
    eyebrow: "BUILT WITH DROMMER",
    title: "Projects we've been part of",
  },
  reunion: {
    location: "Drommer - Chiasso, Switzerland",
    title: "Spend a day with us at the next Drommer Reunion",
    join: "Join us →",
  },
  studio: {
    eyebrow: "VENTURE BUILDER STUDIO",
    titleLine1: "Not just a founder program.",
    titleLine2: "We build companies too.",
    p1: "Beyond the Founder Program, Drommer works with startups and companies that need an operational partner to launch a new initiative. We don't advise. We build, with a dedicated team, in weekly execution cycles, from first test to first sale.",
    p2: "If you have an initiative that needs to move fast and you don't want to build an internal team from scratch, this is how we work together.",
  ...
  finalCta: {
    companiesTitle: "Let’s build together",
    companiesP1:
      "You have an initiative that needs to move. We bring the team, the process, and the execution. No internal",
    companiesP2: "structures to build from scratch, just results.",
    foundersTitle: "Become an entrepreneur",
    foundersP1:
      "You have the drive. We have the program, the network, and the team to build with you.",
    foundersP2: "Apply for the next cohort, spots are limited.",
  },
  about: {
    eyebrow: "ABOUT US",
    title: "The team that builds with you",
    subtitle:
      "The people behind the program. The venture builder behind the startups. Based in Ticino, on the Swiss-Italian border, building across Europe.",
    originEyebrow: "ORIGIN",
    originTitle: "Built by someone who was looking for it too",
    originP1:
      "Gianluca spent years in the startup world looking for one thing: a place that actually helped young people build companies, not just talk about it. He never found it. So he built it.",
    originP2:
      "Today Drommer is a venture builder based in Switzerland. We run the Founder Program to find, develop and co-build the next generation of European entrepreneurs. We don't teach. We build, and we don't leave until it's done .",
    visionEyebrow: "VISION",
    visionTitle: "A room to build in",
    visionP1:
      "The next generation of great companies will be built by people who had the drive but lacked the right place to start. We're building that place.",
    visionP2:
      "The goal is simple: make Drommer the home where young European entrepreneurs come to build, and where starting a company feels like the most natural thing in the world.",
    hqEyebrow: "DROMMER HQ",
    hqTitle: "Vela4, Home Base",
    hqBody:
      "300 square meters in Chiasso, Switzerland, where founders work, meet and build every day. We started with one room. We're already expanding. The goal: make Ticino the kind of place every founder in Europe knows by name.",
    experienceEyebrow: "EXPERIENCE",
    experienceTitle: "What it feels to be here",
    experienceBody:
      "Once a month, founders travel to Ticino (CH). There are no slides, no lectures. There are Proof Tables, workshops, dinners and conversations that don't end until late. The people in the room are entrepreneurs, operators and investors: all with something real to say. You leave with more clarity, more connections and a stronger reason to keep building.",
    foundersEyebrow: "THE FOUNDERS",
    foundersTitle: "The people who chose to build",
    foundersBody:
      "The people building inside the Drommer Founder Program. Some still in the program, some already out in the world with their startup. Each one entered with an idea, or without one. All of them chose to move.",
  },
  caseStudiesIndex: {
    title: "Case Studies",
    subtitle:
      "We build ventures alongside founders, from the first problem to a business built for the real world.",
    kaleba:
  ...
  studies: {
    ...
    okrogito: {
      ...
      quoteRole: "Future CCO & Co-Founder, Head of Real Estate",
    },
    prisma: {
      status: "Launched",
      summary:
      ...
      quoteRole: "Founder of Prisma AI Group",
    },
  },
  challenge: {
    nav: {
    ...
    hero: {
      ...
      title: "THE FUTURE OF PEOPLE OPERATIONS",
      subtitle: "Turn a broken HR process into an AI-native service business.",
      line: "HR is still full of slow, manual and fragmented processes. We’re looking for people ready to rethink one of them from scratch using AI.",
      punch: "You don’t need a startup. You need a problem worth solving.",
      apply: "Apply Now",
      seeHow: "See how it works",
      stats: [
        { label: "APPLICATIONS OPEN", value: "21 September" },
        { label: "BUILD & PITCH DAY", value: "7 November" },
        { label: "LOCATION", value: "Chiasso, Switzerland" },
      ],
    },
    problem: {
      eyebrow: "THE CHALLENGE",
      title: "HR is full of processes ready to be rebuilt.",
      problemLabel: "01 / THE PROBLEM",
      problemTitle: "Too much work still happens manually.",
      problemBody:
        "Recruiting, onboarding, payroll, training, performance, compliance, people analytics. Too many workflows still rely on emails, spreadsheets, repetitive tasks and handovers between people.",
      opportunityLabel: "02 / THE OPPORTUNITY",
      opportunityTitle: "Rethink how HR works with AI.",
      opportunityBody:
        "Which HR process could be fundamentally rethought with AI? Pick one real problem and imagine a better way to deliver the service. Not another software tool with AI added on top, but an AI-native service business where AI changes how the work is done, making the service faster, simpler and more scalable.",
      strip: "Pick the problem you know best. Rebuild it your way.",
    },
    who: {
      eyebrow: "WHO CAN APPLY",
      title: "You can start with just the problem.",
      intro: "No startup. No team. No MVP. No perfect pitch deck.",
      need: "You just need something worth exploring:",
      items: [
        "A problem you know well",
        "An inefficiency you’ve seen first-hand",
        "An early idea",
        "An insight you want to test",
      ],
      close:
        "We’re not looking for finished startups. We’re looking for people ready to build one.",
    },
    journey: {
      eyebrow: "THE JOURNEY",
      title: "From a problem to the market.",
      step: "STEP",
      items: [
        {
          num: "01",
          title: "APPLY",
          date: "Applications open 21 September · Close\u00A027\u00A0October",
          body: "Tell us who you are, the problem you want to solve and why it matters. Only the 10 strongest founders will be selected.",
        },
        {
          num: "02",
          title: "BUILD & PITCH DAY",
          date: "7 NOVEMBER · DROMMER HQ, CHIASSO",
          body: "One intensive day to challenge the problem, sharpen the idea and turn it into a first venture proposal. Work with Drommer and industry experts. Pitch it at the end of the day. Only 5 founders will move forward.",
        },
        {
          num: "03",
          title: "5 WEEKS TO REVENUE",
          date: "9 NOVEMBER – 11 DECEMBER",
          body: "The selected founders join the program for free. Five weeks to validate the problem, talk to customers, shape the offer, test pricing and start selling. No theory. No waiting. Real market proof.",
        },
      ],
      goalLead: "The goal isn’t a better pitch.",
      goalAccent: "It’s real market proof.",
    },
    benefits: {
      eyebrow: "WHAT YOU GET",
      title: "Five weeks. Full focus.",
      items: [
        {
        ...
        {
          title: "Weekly Workshops",
          body: "Practical weekly sessions focused on validation, offer design, pricing, go-to-market and sales.",
        },
        {
          title: "Drommer HQ Access",
          body: "Workspace in Chiasso, access to the Drommer founder community and in-person gatherings.",
        },
        {
          title: "Founder Fridays",
          body: "Weekly in-person build days alongside Drommer and the other founders.",
        },
        {
          title: "Industry Experts",
          body: "Direct access to people who understand the HR market, its processes and its real problems.",
        },
        {
          title: "Market Validation",
          body: "Customer conversations, offer testing, pricing and first commercial traction.",
        },
      ],
    },
    topics: {
      eyebrow: "WHERE TO START",
      title: "One industry. Many problems worth solving.",
      items: [
        "Recruiting",
        "Talent Acquisition",
        "Onboarding",
      ...
      note: "These are starting points, not boundaries. If you’ve found another People Operations problem that is manual, expensive or unnecessarily complex, we want to hear it.",
    },
    dates: {
      eyebrow: "KEY DATES",
      title: "Know what you’re signing up for.",
      body: "The program is built for people who are serious about execution. Commitment and availability are part of the selection criteria.",
      items: [
        { date: "21 SEPTEMBER – 28 OCTOBER", title: "Applications open", note: "" },
        { date: "7 NOVEMBER", title: "Build & Pitch Day", note: "Chiasso · in person" },
        { date: "9 NOVEMBER – 11 DECEMBER", title: "5 Weeks to Revenue", note: "Hybrid" },
        { date: "11 DECEMBER", title: "Final Review Day", note: "Chiasso · in person" },
      ],
    },
    apply: {
      eyebrow: "THE FUTURE OF PEOPLE OPERATIONS",
      title: "Found a problem worth fixing?",
      body: "Tell us why it matters and why you should be the person to build the solution. Applications open 21 September.",
      footnote: "10 founders will be invited to the Build & Pitch Day in Chiasso.",
    },
    faq: {
      eyebrow: "FAQ",
      ...
      entries: [
        {
          question: "Do I need to already have a startup?",
          answer:
            "No. You can apply with a problem you know well, an early idea or an insight you want to test. We are selecting people with the drive to build, not finished companies.",
        },
        {
          question: "Do I need a team?",
          answer:
            "No. Solo founders are welcome. You do not need a co-founder or an existing team to apply.",
        },
        {
          question: "Is the program free?",
          answer:
            "Yes. The five founders selected after Build & Pitch Day access the full five-week program completely free.",
        },
        {
          question: "Is in-person attendance mandatory?",
          lead: "Yes. The 5 Weeks to Revenue follow a hybrid format, but attendance in Chiasso is required for the key in-person moments of the program:",
          items: [
            { date: "7 November", label: "Build & Pitch Day" },
            { date: "10–13 November", label: "Drommer Reunion" },
            { date: "Every Friday", label: "Founder Fridays during the program" },
            { date: "1–4 December", label: "Drommer Reunion" },
            { date: "11 December", label: "Final Review" },
          ],
          tail: "All other mentoring sessions and activities may take place online.",
        },
        {
          question: "Where does the program take place?",
          answer:
            "The Build & Pitch Day, Founder Fridays and Final Review take place in person at Drommer HQ in Chiasso, Switzerland.",
        },
      ],
    },
    footer: {
      blurb:
        "We build companies with ambitious founders, from first insight to market proof.",
      locationLabel: "LOCATION",
      location: "Chiasso, Switzerland",
      connect: "CONNECT",
      email: "Email",
      rights: "© 2026 Drommer. All rights reserved.",
      privacy: "Privacy",
      imprint: "Imprint",
      applicationsOpen: "Applications open",
      applicationsDate: "21 September",
    },
  },
  meta: {
    homeDescription:
      "The Founder Program is where you stop dreaming about starting a company and actually do it.",
    challengeTitle: "Founder Challenge: Future of People Operations | Drommer",
